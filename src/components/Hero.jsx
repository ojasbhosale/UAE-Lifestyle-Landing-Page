...
const Hero = () => {
  ...
  const scrollToSignup = () => {
    const signupSection = document.getElementById("community")
    if (signupSection) {
      ...
      <div className="hero-container">
        <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
          <motion.h1 className="hero-title" variants={itemVariants}>
            Live <span className="text-gradient">the UAE Lifestyle</span> Like Never Before
          </motion.h1>
          ...
          <motion.p className="hero-subtitle" variants={itemVariants}>
            From epic beach clubs to desert thrills, insider career hacks to the hottest nightlife – we bring the UAE to your screen, and your weekends.
          </motion.p>
          ...
          <motion.div className="hero-buttons" variants={itemVariants}>
            ...
            <motion.button
              ...
              onClick={() => document.getElementById("beaches").scrollIntoView({ behavior: "smooth" })}
              variants={buttonVariants}
              whileHover="hover"
              whileTap="tap"
            >
