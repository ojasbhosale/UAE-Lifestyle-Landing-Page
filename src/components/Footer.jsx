    ...
    <footer className="footer">
      ...
      <div className="container">
        ...
        >
          <motion.div className="footer-logo-section" variants={itemVariants}>
            <h3 className="footer-logo">
              UAE <span className="text-gradient">Lifestyle</span>
            </h3>
            <p>Live the UAE Lifestyle Like Never Before</p>
          ...
          <motion.div className="footer-links-section" variants={itemVariants}>
            ...
            <div className="footer-links-group">
              ...
              <p className="footer-contact-info">
                <span>Email:</span> contact@uaelifestyle.com
              </p>
              <button
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p>&copy; {currentYear} UAE Lifestyle. All rights reserved.</p>
